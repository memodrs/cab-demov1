	...
	public CardState getCardForId(int id) {
		...
		switch (id) {
			...
			case Ids.PUPPE:            return new Puppe(           card, cardGame, State.graveState,        Trigger.triggerOnHandDamageDirekterAngriff,                                 State.ignoreState                  );
			  ...
			  //SEGEN
			case Ids.SCHWERT:          return new Schwert(            card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.BESCHWOERUNG:     return new Beschwoerung(       card, cardGame, State.boardState,	   State.ignoreState);
			case Ids.AMULETT:          return new Amulett(            card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.WANDEL:           return new Wandel(             card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.FLUEGEL:          return new Fluegel(            card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.SCHILD:           return new Schild(             card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.STURMANGRIFF:     return new Sturmangriff(       card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.YINGUNDYANG:      return new YingUndYang(        card, cardGame, State.boardState,    State.effektSelectOwnGraveState);
			case Ids.SCHWARM:          return new Schwarm(            card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.GNADE:            return new Gnade(              card, cardGame, State.boardState,	   State.effektSelectOwnGraveState);
			case Ids.QUELLE:           return new Quelle(             card, cardGame, State.boardState,	   State.ignoreState);
			case Ids.SCHILDUNDSCHWERT: return new SchildUndSchwert(   card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.KESSEL:           return new Kessel(             card, cardGame, State.handCardState, State.ignoreState);
			case Ids.FLEISCH:          return new Fleisch(            card, cardGame, State.boardState,    State.ignoreState);
			case Ids.HETZE:            return new Hetze(              card, cardGame, State.boardState,	   State.ignoreState);
			case Ids.AUFSTIEG:         return new Aufstieg(           card, cardGame, State.boardState,	   State.effektSelectOwnBoardState);
			case Ids.RUFDERDUNKELHEIT: return new RufDerDunkelheit(   card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.HIMMLICHERRUF:    return new HimmlicherRuf(      card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.AUFRUFUNG:        return new Aufrufung(          card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.HEN:              return new SegenDerSterblichen(card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.SEGENDERBESTIEN:  return new SegenDerBestien(    card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.SEGENDERFABEL:    return new SegenDerFabel(      card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.SEGENDERDUNKLEN:  return new SegenDerDunklen(    card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.VERSTAERKUNG:     return new Verstaerkung(       card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.VOLLMOND:         return new Vollmond(           card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.REGENBOGEN:       return new Regenbogen(         card, cardGame, State.boardState,	   State.selectOptionCardListState);
			case Ids.SONNENFINSTERNIS: return new Sonnenfinsternis(   card, cardGame, State.boardState,	   State.selectOptionCardListState);

			  //FLUCH
			case Ids.FLASCHE:        return new Flasche(       card, cardGame, State.graveOponentState, State.effektSelectOponentBoardState);
			case Ids.FLUCH:          return new Fluch(         card, cardGame, State.graveOponentState, State.effektSelectOponentBoardState);
			case Ids.FALLE:          return new Falle(         card, cardGame, State.graveOponentState, State.effektSelectOponentBoardState);
			case Ids.STURM:          return new Sturm(         card, cardGame, State.handCardState, 	State.ignoreState);
			case Ids.UEBERSTRAHLUNG: return new Ueberstrahlung(card, cardGame, State.handCardState,     State.ignoreState);
			case Ids.HYPNOSE:        return new Hypnose(       card, cardGame, State.boardState,	 	State.effektSelectOponentBoardState);
			case Ids.GEWITTER:       return new Gewitter(      card, cardGame, State.handCardState, 	State.effektSelectOponentBoardState);
			case Ids.FEUER:          return new Feuer(         card, cardGame, State.handCardState, 	State.effektSelectOponentBoardState);
			case Ids.BRAND:          return new Brand(         card, cardGame, State.handCardState, 	State.ignoreState);
			case Ids.OPFERGABE:      return new Opfergabe(     card, cardGame, State.handCardState, 	State.effektSelectOwnBoardState);
			case Ids.VERLORENESLAND: return new VerlorenesLand(card, cardGame, State.handCardState, 	State.effektSelectOponentBoardState);
			case Ids.KATASTROPHE:    return new Katastrophe(   card, cardGame, State.handCardState, 	State.ignoreState);
			case Ids.HETZJAGD:       return new Hetzjagd(      card, cardGame, State.handCardState, 	State.ignoreState);
			case Ids.VOGELSCHEUCHE:  return new Vogelscheuche( card, cardGame, State.handCardState, 	State.ignoreState);
			case Ids.ALCHEMIE:       return new Alchemie(      card, cardGame, State.boardState, 		State.selectOptionState);
