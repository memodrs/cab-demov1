...
public class SegenDerBestien extends EffektCardState {

	public SegenDerBestien(Card card, CardGame cardGame, int nextStateForPlayer, int triggerState, int selectState) {
