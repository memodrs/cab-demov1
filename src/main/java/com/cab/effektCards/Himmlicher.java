...
public class Himmlicher extends EffektCardState implements EffektCard {

	public Himmlicher(Card card, CardGame cardGame, int nextStateForPlayer, int triggerState, int selectState) {
