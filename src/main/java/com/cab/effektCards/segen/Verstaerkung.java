...
public class Verstaerkung extends EffektCardState {

	public Verstaerkung(Card card, CardGame cardGame, int nextStateForPlayer, int triggerState, int selectState) {
